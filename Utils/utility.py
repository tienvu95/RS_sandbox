...
def print_results(precision, recall, f_score, NDCG):
    print(f'P@01: {precision[0]}, P@05: {precision[1]}, P@10: {precision[2]}, P@15: {precision[3]}')
    print(f'R@01: {recall[0]}, R@05: {recall[1]}, R@10: {recall[2]}, R@15: {recall[3]}')
    print(f'F@01: {f_score[0]}, F@05: {f_score[1]}, F@10: {f_score[2]}, F@15: {f_score[3]}')
    print(f'N@01: {NDCG[0]}, N@05: {NDCG[1]}, N@10: {NDCG[2]}, N@15: {NDCG[3]}')